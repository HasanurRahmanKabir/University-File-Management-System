<header class="topbar">
    ...
    <div class="tb-right">
        ...
        <div class="dropdown" style="display: flex; align-items: center;">
            <div class="tb-avatar" data-bs-toggle="dropdown" aria-expanded="false" style="cursor: pointer; {{ Auth::user()->profile_image ? 'background: #fff;' : 'background: linear-gradient(135deg, var(--primary), var(--primary-dark));' }} box-shadow: 0 3px 10px rgba(59,130,246,0.3); border: 2px solid #fff; display: flex; align-items: center; justify-content: center; color: #fff; font-weight: 700; font-size: 0.9rem; overflow: hidden; border-radius: 50%;">
