...
<head>
    ...
    <title>@yield('title', 'Student Dashboard - OBE System')</title>
    ...
    <div class="sidebar" id="sidebar">
        <div>
            ...
            <ul class="nav flex-column">
                <li class="nav-item"><a href="{{ route('student.dashboard') ?? '#' }}" class="nav-link {{ request()->routeIs('student.dashboard') ? 'active' : '' }}"><i class="fas fa-home me-2"></i> Dashboard</a></li>
                <li class="nav-item"><a href="{{ route('student.courses.index') }}" class="nav-link {{ request()->routeIs('student.courses.*') ? 'active' : '' }}"><i class="fas fa-book me-2"></i> Course Info</a></li>
                <li class="nav-item"><a href="{{ route('student.course-materials.index') }}" class="nav-link {{ request()->routeIs('student.course-materials.*') ? 'active' : '' }}"><i class="fas fa-file-alt me-2"></i> Course File Info</a></li>
