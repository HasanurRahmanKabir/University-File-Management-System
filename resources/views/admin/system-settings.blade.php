            ...
            <div class="data-card h-100 m-0">
                ...
                <div class="card-body p-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="brand_tagline" class="form-input" value="{{ $settings['brand_tagline'] ?? '' }}">
                    </div>
                    <div class="form-group mb-0">
                        <label class="form-label">Footer Copyright Text</label>
                        <input type="text" name="footer_copyright" class="form-input" value="{{ $settings['footer_copyright'] ?? '' }}">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="data-card h-100 m-0">
                ...
                <div class="card-body p-4">
                    <div class="form-group">
                        ...
                        <input type="email" name="system_email" class="form-input" value="{{ $settings['system_email'] ?? '' }}">
                    </div>
                    <div class="form-group mb-0">
                        <label class="form-label">Current Academic Session</label>
                        <input type="text" name="academic_session" class="form-input" value="{{ $settings['academic_session'] ?? '' }}" placeholder="e.g. 2025-2026">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="data-card h-100 m-0">
                ...
                <div class="card-body p-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="admin_dashboard_name" class="form-input" value="{{ $settings['admin_dashboard_name'] ?? '' }}">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Browser Tab Title</label>
                        <input type="text" name="admin_tab_title" class="form-input" value="{{ $settings['admin_tab_title'] ?? '' }}">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <div class="file-upload-wrapper">
                            ...
                            <div class="file-upload-placeholder" style="{{ isset($settings['admin_logo']) && $settings['admin_logo'] ? 'display:none;' : 'display:block;' }}">
                                <i class="fas fa-cloud-upload-alt file-upload-icon"></i>
                                <div class="file-upload-text">Drag & drop or click to upload logo</div>
                            </div>
                            
                            <div class="preview-container" style="{{ isset($settings['admin_logo']) && $settings['admin_logo'] ? 'display:inline-block;' : 'display:none;' }}">
                                <button type="button" class="remove-logo-btn" onclick="removeLogo(event, this)"><i class="fas fa-times"></i></button>
                                <img id="admin-logo-preview" class="preview-logo" src="{{ isset($settings['admin_logo']) ? asset('storage/' . $settings['admin_logo']) : '' }}" style="display:block;" alt="Preview">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="data-card h-100 m-0">
                ...
                <div class="card-body p-4">
                    <div class="form-group">
                        <label class="form-label">Dashboard Name (Appears in Sidebar)</label>
                        <input type="text" name="teacher_dashboard_name" class="form-input" value="{{ $settings['teacher_dashboard_name'] ?? '' }}">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Browser Tab Title</label>
                        <input type="text" name="teacher_tab_title" class="form-input" value="{{ $settings['teacher_tab_title'] ?? '' }}">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <div class="file-upload-wrapper">
                            ...
                            <div class="file-upload-placeholder" style="{{ isset($settings['teacher_logo']) && $settings['teacher_logo'] ? 'display:none;' : 'display:block;' }}">
                                <i class="fas fa-cloud-upload-alt file-upload-icon"></i>
                                <div class="file-upload-text">Drag & drop or click to upload logo</div>
                            </div>
                            
                            <div class="preview-container" style="{{ isset($settings['teacher_logo']) && $settings['teacher_logo'] ? 'display:inline-block;' : 'display:none;' }}">
                                <button type="button" class="remove-logo-btn" onclick="removeLogo(event, this)"><i class="fas fa-times"></i></button>
                                <img id="teacher-logo-preview" class="preview-logo" src="{{ isset($settings['teacher_logo']) ? asset('storage/' . $settings['teacher_logo']) : '' }}" style="display:block;" alt="Preview">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-4 col-md-6">
            <div class="data-card h-100 m-0">
                ...
                <div class="card-body p-4">
                    <div class="form-group">
                        <label class="form-label">Dashboard Name (Appears in Sidebar)</label>
                        <input type="text" name="student_dashboard_name" class="form-input" value="{{ $settings['student_dashboard_name'] ?? '' }}">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Browser Tab Title</label>
                        <input type="text" name="student_tab_title" class="form-input" value="{{ $settings['student_tab_title'] ?? '' }}">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <div class="file-upload-wrapper">
                            ...
                            <div class="file-upload-placeholder" style="{{ isset($settings['student_logo']) && $settings['student_logo'] ? 'display:none;' : 'display:block;' }}">
                                <i class="fas fa-cloud-upload-alt file-upload-icon"></i>
                                <div class="file-upload-text">Drag & drop or click to upload logo</div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="login_title" class="form-input" value="{{ $settings['login_title'] ?? '' }}" placeholder="e.g. Welcome Back!">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Browser Tab Title</label>
                                <input type="text" name="login_tab_title" class="form-input" value="{{ $settings['login_tab_title'] ?? '' }}">
                            ...
                            <div class="form-group mb-lg-0">
                                ...
                                <input type="text" name="login_subtitle" class="form-input" value="{{ $settings['login_subtitle'] ?? '' }}" placeholder="e.g. Enter your credentials to access the portal">
                            </div>
                            <div class="form-group mt-3 mb-lg-0">
                                <label class="form-label">Login Logo Tagline</label>
                                <input type="text" name="login_logo_tagline" class="form-input" value="{{ $settings['login_logo_tagline'] ?? '' }}" placeholder="e.g. University File Management System">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-0">
                                ...
                                <div class="file-upload-wrapper">
                                    ...
                                    <div class="file-upload-placeholder" style="{{ isset($settings['login_logo']) && $settings['login_logo'] ? 'display:none;' : 'display:block;' }}">
