            ...
            <table class="t-tbl" style="width: 100%; min-width: 840px; text-align: center; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; max-width: 140px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><span class="badge b-gray">{{ $course->credit ?? 'N/A' }}</span></td>
