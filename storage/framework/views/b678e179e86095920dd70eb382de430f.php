...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Teacher Dashboard - OBE System'); ?></title>
    ...
    <div class="sidebar" id="sidebar">
        <div>
            ...
            <ul class="nav flex-column">
                <li class="nav-item"><a href="<?php echo e(route('teacher.dashboard') ?? '#'); ?>" class="nav-link <?php echo e(request()->routeIs('teacher.dashboard') ? 'active' : ''); ?>"><i class="fas fa-chalkboard-teacher me-2"></i> Teacher Dashboard</a></li>
                <li class="nav-item"><a href="<?php echo e(route('teacher.courses.index')); ?>" class="nav-link <?php echo e(request()->routeIs('teacher.courses.*') ? 'active' : ''); ?>"><i class="fas fa-book me-2"></i> My Course Info</a></li>
                <li class="nav-item"><a href="<?php echo e(route('teacher.course-materials.index')); ?>" class="nav-link <?php echo e(request()->routeIs('teacher.course-materials.*') ? 'active' : ''); ?>"><i class="fas fa-upload me-2"></i> Upload Materials</a></li>
...
<?php /**PATH C:\Users\Hasanur Rahman Kabir\Documents\University File Management System\University-File-Management-System\resources\views\layouts\teacher.blade.php ENDPATH**/ ?>