<aside class="sidebar" id="sidebar">
    <div class="sb-scroll">
        <div class="sb-brand">
            <div class="sb-logo" style="<?php echo e(isset($globalSettings['student_logo']) && $globalSettings['student_logo'] ? 'background: transparent; box-shadow: none;' : ''); ?>">
            ...
            <div>
                <span class="sb-brand-name"><?php echo e($globalSettings['student_dashboard_name'] ?? 'StudentHub'); ?></span>
