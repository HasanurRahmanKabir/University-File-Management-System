    ...
    <div class="sb-scroll">
        ...
        <nav class="sb-nav">
            ...
            <ul>
                ...
                <li><a href="<?php echo e(route('student.announcements.index')); ?>" class="sb-link <?php echo e(request()->routeIs('student.announcements.*') ? 'active' : ''); ?>">
                    <div class="sb-ico"><i class="fas fa-bullhorn" title="Class Notices"></i></div><span class="sb-text">Class Notices</span>
                </a></li>
                <li><a href="<?php echo e(route('student.instructors')); ?>" class="sb-link <?php echo e(request()->routeIs('student.instructors') ? 'active' : ''); ?>">
