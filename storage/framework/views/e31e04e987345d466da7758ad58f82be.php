...
<head>
    ...
    <?php if(isset($globalSettings['admin_favicon']) && $globalSettings['admin_favicon']): ?>
        <link rel="icon" type="image/x-icon" href="<?php echo e(asset('storage/' . $globalSettings['admin_favicon'])); ?>">
    <?php endif; ?>
