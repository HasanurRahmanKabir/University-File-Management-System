    ...
    <div class="sb-scroll">
        ...
        <nav class="sb-nav">
            ...
            <ul>
                ...
                <li><a href="<?php echo e(route('teacher.announcements.index')); ?>" class="sb-link <?php echo e(request()->routeIs('teacher.announcements.*') ? 'active' : ''); ?>"><div class="sb-ico"><i class="fas fa-bullhorn" title="Course Announcements"></i></div><span class="sb-text">Course Announcements</span></a></li>
