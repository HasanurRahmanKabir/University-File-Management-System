...
<head>
    ...
    <meta name="description" content="Student Dashboard — University OBE File Management System">
    <title><?php echo $__env->yieldContent('title', 'Dashboard — StudentHub OBE'); ?></title>
...
<div class="main">
    ...
    <!-- FOOTER -->
    <?php echo $__env->make('layouts.partials.student-footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
