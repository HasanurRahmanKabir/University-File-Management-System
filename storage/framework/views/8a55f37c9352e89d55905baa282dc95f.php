...
<div class="stats-grid mb-4">
    <div class="stat-card sc-green" style="animation-delay:.06s">
        ...
        <div class="stat-body">
            ...
            <div class="stat-val" style="font-size: 1.4rem;"><?php echo e($activeSemester ? $activeSemester->name . ' ' . $activeSemester->year : 'No Active Semester'); ?></div>
...
<div class="d-card" style="animation-delay:.06s">
    <div class="d-card-header">
        ...
        <?php if($activeSemester): ?>
            <span class="badge b-green" style="padding:5px 12px;"><?php echo e($activeSemester->name); ?> <?php echo e($activeSemester->year); ?></span>
        <?php endif; ?>
    </div>
...
<?php $__empty_1 = true; $__currentLoopData = $groupedPreviousCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semesterName => $courses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
<div class="d-card mb-4" style="animation-delay:.<?php echo e(12 + ($loop->index * 2)); ?>s">
    <div class="d-card-header" style="background: #f8fafc; border-bottom: 1px solid var(--border-light); padding: 12px 20px;">
        <div class="d-card-title" style="font-size: 1.1rem; color: var(--text-heading);">
            ...
            <?php echo e($semesterName); ?>

        </div>
        <span class="badge b-gray" style="padding:5px 12px; font-weight: 600;"><?php echo e($courses->count()); ?> <?php echo e(Str::plural('Course', $courses->count())); ?></span>
    </div>
    <div class="d-card-body p0">
        <div class="t-wrap">
            <table class="t-tbl">
    ...
    <form action="<?php echo e(route('teacher.courses.store')); ?>" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <?php if($teacherDepartmentId): ?>
                    <input type="hidden" name="department_id" value="<?php echo e($teacherDepartmentId); ?>">
                    <input type="text" class="form-control form-control-lg fs-6" value="<?php echo e($departments->firstWhere('id', $teacherDepartmentId)?->name ?? 'N/A'); ?>" disabled style="background: #f8fafc; color: #64748b; cursor: not-allowed; border: 1px solid #e2e8f0;">
    ...
    <form id="editCourseForm" action="" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-12">
                <label class="form-label fw-bold text-dark small mb-1">Department</label>
                <?php if($teacherDepartmentId): ?>
                    <input type="hidden" name="department_id" id="edit_dept_hidden" value="<?php echo e($teacherDepartmentId); ?>">
                    <input type="text" id="edit_dept_display" class="form-control form-control-lg fs-6" value="<?php echo e($departments->firstWhere('id', $teacherDepartmentId)?->name ?? 'N/A'); ?>" disabled style="background: #f8fafc; color: #64748b; cursor: not-allowed; border: 1px solid #e2e8f0;">
                    <small class="text-muted" style="font-size: 0.78rem;"><i class="fas fa-lock me-1"></i>Auto-assigned from your department</small>
                <?php else: ?>
        ...
        editButtons.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                if (editDeptHidden) {
                    ...
                    const deptMap = {
                        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        "<?php echo e($dept->id); ?>": "<?php echo e($dept->name); ?>",
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    };
