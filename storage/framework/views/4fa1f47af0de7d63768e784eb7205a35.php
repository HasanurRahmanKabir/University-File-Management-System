<?php $__env->startSection('title', 'Account Settings — TeacherHub OBE'); ?>
...
<div class="p-hero">
    ...
    <a href="<?php echo e(route('teacher.profile')); ?>" class="btn-primary" style="background: var(--bg-muted); color: var(--tx-h); box-shadow: none; border: 1px solid var(--bd-lt);"><i class="fas fa-arrow-left"></i> Back to Profile</a>
</div>
...
<div class="d-card" style="animation-delay:.05s; max-width: 900px; margin: 0 auto 30px;">
    ...
    <form action="<?php echo e(route('teacher.settings.update')); ?>" method="POST">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div style="position: relative;">
                            ...
                            <input type="text" class="form-control" value="<?php echo e($user->designation); ?>" disabled 
        ...
        <div class="settings-footer">
            <a href="<?php echo e(route('teacher.profile')); ?>" class="btn settings-btn-cancel"><i class="fas fa-times" style="margin-right: 6px;"></i> Cancel</a>
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Hasanur Rahman Kabir\Documents\University File Management System\University-File-Management-System\resources\views/teacher/settings.blade.php ENDPATH**/ ?>