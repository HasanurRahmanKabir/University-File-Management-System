...
<?php $__env->startSection('breadcrumb', 'Course Materials'); ?>
                        ...
                        <tr>
                            <td>
                                <div class="user-cell">
                                    ...
                                    ?>
                                    <div class="avatar-sm <?php echo e($color); ?>"><i class="<?php echo e($icon); ?>"></i></div>
                                    <div>
                                        <div class="user-name"><?php echo e($material->title); ?></div>
                                        <div class="user-sub"><?php echo e(strtoupper($material->file_type)); ?> • <?php echo e(round($material->file_size / 1024, 2)); ?> KB</div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div>
                                    <div class="user-name"><?php echo e($material->course->course_code ?? 'N/A'); ?></div>
                                    <div class="user-sub"><?php echo e($material->course->course_name ?? 'Unknown Course'); ?></div>
                                </div>
                            </td>
                            <td>
                                <?php if($material->uploader): ?>
                                    <span class="badge success"><i class="fas fa-user"></i> <?php echo e($material->uploader->name); ?></span>
                                <?php else: ?>
                                    <span class="badge neutral">System</span>
                                <?php endif; ?>
                            </td>
                            <td><span style="font-size: 13px; color: #64748b;"><?php echo e($material->created_at->format('d M, Y h:i A')); ?></span></td>
                            <td>
                                <div class="action-group">
                                    <a href="<?php echo e(Storage::url($material->file_path)); ?>" target="_blank" class="action-btn" style="background: #eff6ff; color: #3b82f6;" title="Download">
                                    ...
                                    <form action="<?php echo e(route('admin.course-materials.destroy', $material->id)); ?>" method="POST" class="m-0 p-0" style="display: flex; align-items: center;">
                                        <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content premium">
                ...
                <div class="modal-body-content">
                    <form method="POST" action="<?php echo e(route('admin.course-materials.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            ...
                            <select class="form-select" name="course_id" required>
                                ...
                                <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($course->id); ?>"><?php echo e($course->course_code); ?> - <?php echo e($course->course_name); ?></option>
