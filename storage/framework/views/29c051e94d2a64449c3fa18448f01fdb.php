...
<head>
    ...
    <?php if(isset($globalSettings['login_favicon']) && $globalSettings['login_favicon']): ?>
        <link rel="icon" type="image/x-icon" href="<?php echo e(asset('storage/' . $globalSettings['login_favicon'])); ?>">
    <?php endif; ?>
