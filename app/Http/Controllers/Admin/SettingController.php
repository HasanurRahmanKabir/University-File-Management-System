...
class SettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $data = $request->except([
            ...
            'admin_favicon', 'teacher_favicon', 'student_favicon', 'login_favicon',
            'remove_admin_favicon', 'remove_teacher_favicon', 'remove_student_favicon', 'remove_login_favicon'
        ]);
        ...
        // Handle file uploads (Logos and Favicons)
        $filesToUpload = [
            'admin_logo', 'teacher_logo', 'student_logo', 'login_logo',
            'admin_favicon', 'teacher_favicon', 'student_favicon', 'login_favicon'
        ];

        foreach ($filesToUpload as $logo) {
